Shader "Clipping_Plane_filled"{
	...
	SubShader{
		...
		void surf (Input i, inout SurfaceOutputStandard o) {
			...
			//o.Emission = lerp(_CutoffColor, _Emission, facing); // original
			o.Emission = lerp(_Color, _Emission, facing);  // color de relleno igual que el material
		}
		ENDCG
	}
